    ...
    <div class="container d-flex justify-content-center">
        <div class="salary-container">
            <div class="logo-title-container">
                ...
                <h3 class="text-center">Add New Salary</h3>
            </div>
            ...
            <form action="<?= base_url('save-salary') ?>" method="POST">
                <?= csrf_field() ?>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group <?= $validation && $validation->hasError('amount_paid') ? 'is-invalid' : '' ?>">
                        ...
                        <input type="number" name="amount_paid" id="amount_paid" class="form-control <?= $validation && $validation->hasError('amount_paid') ? 'is-invalid' : '' ?>" value="<?= old('amount_paid') ?>" placeholder="Enter amount paid">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group <?= $validation && $validation->hasError('payment_date') ? 'is-invalid' : '' ?>">
                        ...
                        <input type="date" name="payment_date" id="payment_date" class="form-control <?= $validation && $validation->hasError('payment_date') ? 'is-invalid' : '' ?>" value="<?= old('payment_date') ?>">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group <?= $validation && $validation->hasError('payment_method') ? 'is-invalid' : '' ?>">
                        ...
                        <input type="text" name="payment_method" id="payment_method" class="form-control <?= $validation && $validation->hasError('payment_method') ? 'is-invalid' : '' ?>" value="<?= old('payment_method') ?>" placeholder="Enter payment method">
                    </div>
                ...
                <button type="submit" class="btn btn-success btn-block">Save Salary</button>
            </form>
        </div>
    </div>
