...
<head>
    ...
    <title>employees - Dairy Farm</title>
...
<body class="d-flex align-items-center bg-light" style="height: 100vh;">
    <div class="container">
        ...
        <!-- Button to add a new employee and the search bar -->
        <div class="d-flex justify-content-between align-items-center">
            <div class="position-relative" style="max-width: 300px;">
                <input type="text" id="search-bar" class="form-control pr-4" placeholder="Search employees..." oninput="searchEmployees()">
                <i class="fas fa-search search-icon"></i>
            </div>

            <div class="text">
                <a href="<?= base_url('add-employee') ?>" class="btn btn-success mt-3">
        ...
        <?php else: ?>
            <h3 class="text-center">No employees recorded</h3>
        <?php endif; ?>
    ...
    <script>
        // Sample data (replace with your actual employee data array)
        let employees = <?= json_encode($employees) ?>;
        let itemsPerPage = 5; // Default items per page
        let currentPage = 1; // Track the current page
        let filteredEmployees = employees; // Variable to hold filtered data for search
        ...
        function renderTable(page) {
            ...
            paginatedData.forEach(employee => {
                ...
                row.innerHTML = `
                    ...
                    <td>
                        <a href="/edit-employee/${employee.id}" class="btn btn-sm btn-info"><i class="fas fa-edit"></i> Edit</a>
                        <a href="/delete-employee/${employee.id}" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this employee?');"><i class="fas fa-trash"></i> Delete</a>
                    </td>
                `;
            ...
            document.getElementById('pagination-count').textContent = `Page ${page} of ${Math.ceil(filteredEmployees.length / itemsPerPage)}`;
        ...
        function searchEmployees() {
            ...
            filteredEmployees = employees.filter(employee => {
                return (
                    ...
                    employee.hire_date.toLowerCase().includes(searchTerm) ||
